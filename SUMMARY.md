...
- [Jornada do cliente — Fluxogramas](estrategia-mercado/jornada-cliente-fluxogramas.plan.md)
- [Graventum — Identidade e entregas](estrategia-mercado/graventum-identidade-entregas.plan.md)
- [Estudo de mercado — Automação PME Brasil](estrategia-mercado/estudo-mercado-automacao-pme-brasil.plan.md)
- [Primeira impressão Graventum (30h)](estrategia-mercado/primeira-impressao-graventum-30h.plan.md)

## Produto e operação
- [Agentes de IA e BI — Relatório diário](produto-operacao/agentes-ia-bi-relatorio-diario.plan.md)
- [Workflows n8n — Problemas e soluções](produto-operacao/workflows-n8n-problemas-solucoes.plan.md)
...
- [ML no servidor — Modelos e detalhamento](ml-modelos/ml-servidor-modelos-detalhamento.plan.md)
- [Ollama e OpenClaw — Redução de custos](ml-modelos/ollama-openclaw-reducao-custos.plan.md)

## OpenClaw e ferramentas
- [OpenClaw — Melhores práticas e autonomia](openclaw-ferramentas/openclaw-melhores-praticas.plan.md)
- [OpenClaw COO — Capacidade máxima](openclaw-ferramentas/openclaw-coo-capacidade-maxima.plan.md)
...
- [Guia Automação Graventum](https://robsoncaldeira.github.io/docs/dashboards/guia_automacao_graventum.html)
...
- [Fluxograma do sistema completo](documentacao-tecnica/fluxograma-sistema-completo.plan.md)
