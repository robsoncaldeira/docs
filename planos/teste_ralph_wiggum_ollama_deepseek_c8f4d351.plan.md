...
- [ ] Projeto de teste com testes automatizados (para critério de saída)
...
Criar diretório de teste e rodar loop simples:
...
| Bun não instalado | `curl -fsSL https://bun.sh/install \| bash` |
